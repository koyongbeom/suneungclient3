...
const AttendanceMobile: React.FC<any> = (props) => {
    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.dateList}>
                {
                    dateList.map((eachWeek: any, dayNumber: number) => {
                        return (
                            <div key={Math.random()} className={styles.eachWeekDiv}>
                                {
                                    eachWeek.map((eachDay: any, index: number) => {
                                        return (
                                            <div onClick={(e) => { showDetail(e, eachDay.month, eachDay.day, index) }} key={eachDay.day} className={`${styles.eachDay} ${index % 7 === 0 ? styles.sunday : ""} ${eachDay.month !== 3 ? styles.deactive : ""}`} >
                                                {eachDay.day}
                                                {
                                                            ...
                                                            if (indexNumber + 1 === eachDay.day) {
                                                                ...
                                                                return (
                                                                    <div key={eachData.id}>
                                                                        {
                                                                            eachData.length > 0 &&
                                                                            <div className={`${styles.time} ${styles.first} ${(indexNumber === 4 || indexNumber === 8 || indexNumber === 11 || indexNumber === 18) ? styles.late : ""}`}>

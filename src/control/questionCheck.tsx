...
const columns1: GridColDef[] = [
    ...
    { field: 'subject', headerName: '튜터', width: 120 },
    { field: 'chapter', headerName: '일자', width: 80, filterable: true },
    {
    ...
    {
        field: 'text', headerName: '한달 평균', width: 400, renderCell: (params: any) => {
...
const QuestionCheck: React.FC<any> = (props) => {
    ...
    return (
        <div style={{width : "1100px", paddingLeft : "12px"}}>
            <div>

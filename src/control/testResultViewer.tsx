...
const TestResultViewer: React.FC<any> = (props) => {
    ...
    useEffect(()=>{
        const newRows = [
            {
                id : 1, subject : "문학", chapter : "현대시", inCorrectRatio : 85
            },
            {
                id : 2, subject : "문학", chapter : "현대소설", inCorrectRatio : 50
            },
            {
                id : 3, subject : "문학", chapter : "고전시가", inCorrectRatio : 60
            },
            {
                id : 4, subject : "문학", chapter : "고전산문", inCorrectRatio : 70
            },
        ]

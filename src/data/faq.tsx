...
[
    ...
    },
    {
        ...
        answer: '주 1회 30분 진행되며, 배정된 튜터와 정기적으로 상담이 이뤄집니다.'
    },
    {
        category: "mentor",
    ...
    },
    {
        ...
        answer: '담당 튜터가 학생에게 필요하다고 느끼는 과목의 특정 단원 문제를 수능선배 프로그램에서 선별하여 테스트를 구성합니다.\n이 테스트를 학생이 다음 상담 전까지 풀어오는 방식으로 진행되며, 테스트 관련 피드백 및 해설이 상담시간에 진행됩니다.\n매번의 테스트가 프로그램에 기록되고, 틀린문제는 다시 풀어볼 수 있는 기능도 있어 복습이 용이합니다.'
    },
    {
        category: "mentor",
        question: '어떤 담임선생님들이 계신가요? ',
        answer: '아래 링크를 클릭하시면 확인 가능합니다.\n수능선배 튜터는 면접을 통해서 선발하고 있어 우수한 튜터님들로 튜터진을 구성하고 있습니다.\n<a href="https://suneungsunbae.com/teachers">담임선생님 보러 가기</a>'
    },
    {
        category: "mentor",
        question: '멘토배정은 어떻게 이루어지나요?',
        answer: '학생이 원하는 튜터에게 최대한 배정해드리고 있으며,\n특별히 원하는 멘토가 없는경우 첫 등원시 작성하는 학생카드를 참고해서 적합한 튜터에게 배정해드리고\n배정한 이유를 학생분에게 전달드리고 있습니다.\n상담을 받아보시고 추후에 다른 튜터로 변경이 가능합니다.\n단, 배정을 원하는 튜터의 수용인원이 만석인 경우 배정이 어려운 상황이 생길 수 있습니다.'
    },
    {
        category: "question",
